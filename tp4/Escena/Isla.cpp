...
std::vector<Coordenadas> Isla::generarCurvaNivel0(){
    ...
    puntos.push_back(Coordenadas(14.0f,-2.0f,0.0f));
    ...
    puntos.push_back(Coordenadas(-2.0f,-9.0f,0.0f));
    ...
    puntos.push_back(Coordenadas(-9.0f,-1.0f,0.0f));
    puntos.push_back(Coordenadas(-7.0f,2.0f,0.0f));
    puntos.push_back(Coordenadas(-9.0f,4.0f,0.0f));
